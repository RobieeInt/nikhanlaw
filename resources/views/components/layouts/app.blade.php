...
<body class="min-h-screen bg-zinc-50 text-zinc-900 dark:bg-[#0A0A0B] dark:text-zinc-100">
    {{-- Navbar seragam --}}
    @include('landing.partials.navbar', ['variant' => 'auth'])
    ...
    <a href="https://wa.me/6288293280888?text=Hi%2C%20Admin%20Nikhan%20saya%20ada%20kendala%20nih" target="_blank"
        rel="noopener noreferrer" aria-label="Chat WhatsApp Nikhan Law" class="wa-float">
        <!-- Badge -->
        <span class="wa-badge">Ada Kendala? Chat Admin</span>
